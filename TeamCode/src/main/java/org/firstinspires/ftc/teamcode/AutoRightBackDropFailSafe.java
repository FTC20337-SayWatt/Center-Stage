...
@Autonomous (name = "AutoRightBackDropFailSafe", preselectTeleOp = "SayWattTeleOp")
public class AutoRightBackDropFailSafe extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        strafeRight(200, 0.3);
        Thread.sleep(275);
        driveForward(1700, 0.4);
        Thread.sleep(1700);
        strafeRight(1800, 0.3);
        Thread.sleep(1800);
        stop(250);
        lift(500, 0.8);
        Thread.sleep(500);
