...
@Autonomous (name = "AutoRightTrussFailSafe", preselectTeleOp = "SayWattTeleOp")
public class AutoRightTrussFailSafe extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        strafeRight(450, 0.3);
        Thread.sleep(450);
        driveForward(3900, 0.4);
        Thread.sleep(3900);
        strafeRight(1950, 0.3);
        Thread.sleep(1950);
        stop(250);
        lift(1000, 0.8);
        Thread.sleep(500);
